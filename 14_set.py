...
# print(hour_14.union(hour_15))  # set을 반환
# print(hour_15.union(hour_14))  # 위 코드와 동일한 동작
...
# print(hour_15.intersection(hour_14))  # 유니온과 마찬가지로 위 코드와 동일하게 동작
...
# # 제외한 결과를 출력
# print(hour_14.difference(hour_15))
# print(hour_15.difference(hour_14))
